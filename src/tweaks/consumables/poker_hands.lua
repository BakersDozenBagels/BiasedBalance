...
local poker_hands = {
    ...
    ["Straight"] = { 4, 35 }, -- Saturn
    ["Flush"] = { 2, 20 }, -- Jupiter
    ["Full House"] = { 3, 25 }, -- Earth
    ["Four of a Kind"] = { 3, 35 }, -- Mars
    ["Straight Flush"] = { 5, 55, 12, 125 }, -- Neptune
    ["Five of a Kind"] = { 4, 45, 15, 135 }, --Planet X
    ["Flush House"] = { 5, 40, 16, 140 }, -- Ceres
    ["Flush Five"] = { 5, 55, 20, 200 }, -- Eris
}
