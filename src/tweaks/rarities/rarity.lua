...
SMODS.Rarity:take_ownership("Common", {
    ...
    get_weight = function(self, weight, object_type)
        return self.default_weight - 0.27 * (has_pink_deck() + count_caviar())
    end
})
SMODS.Rarity:take_ownership("Uncommon", {
    default_weight = 0.27,
    get_weight = function(self, weight, object_type)
        return self.default_weight + 0.18 * (has_pink_deck() + count_caviar())
    end
})
SMODS.Rarity:take_ownership("Rare", {
    default_weight = 0.06,
    get_weight = function(self, weight, object_type)
        return self.default_weight + 0.09 * (has_pink_deck() + count_caviar())
    end
})
